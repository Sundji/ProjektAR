...
public class AnswerButton : MonoBehaviour
{
	...
	public void OnClick()
    {
        ...
        GetComponentInParent<QuestionsGenerator>().Start();
	...
	public void Set(AnswerData Ans, int order){ //order = a), b), c) ili d) - isto u global negdje skodirat Constants.AnswerOrder[4]
